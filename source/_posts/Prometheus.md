...
stats: "paragraph=38\_sentences=3,\_words=46"
tags:
  - prometheus
...
以上四个组件的所有介绍，可到[Github官网](https://github.com/)，直接搜索相应的docker镜像名称（在下面的部署过程中，每运行一个服务的容器，都会指定其镜像名称，可以参考命令中的镜像名称进行搜索），即可找到到关于组件的详细介绍。
